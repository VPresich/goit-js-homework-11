import{i as l}from"./vendor-9310f15c.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const t of s.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&n(t)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerpolicy&&(s.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?s.credentials="include":e.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();const v="Escape",d="https://pixabay.com/api/",f="40880885-4e0dcc0a0fb77dafc41087a3a";async function p(a,o){return fetch(a).then(r=>{if(!r.ok)throw new Error(r.status);return r.json()})}async function y(a,o,r){const n={key:f,q:encodeURIComponent(a),image_type:"photo",orientation:"horizontal",safesearch:!0,page:1,per_page:20},e=`${d}?${new URLSearchParams(n).toString()}`;p(e).then(s=>{s.hits.length?o&&o(s.hits):r&&r("Sorry, there are no images matching your search query. Please, try again!")}).catch(s=>{throw s})}const u=a=>{const{webformatURL:o,largeImageURL:r,previewURL:n,tags:e,likes:s,views:t,comments:i,downloads:c}=a;return`<li class='card'> 
        ...
        </li>`};function m(a){return a.map(u).join("")}function b(a,o){const r=m(a);o.innerHTML="",o.insertAdjacentHTML("beforeend",r)}const h="/goit-js-homework-11/assets/bi-x-octagon-73f29380.svg";function w(a){l.show({message:a,messageColor:"#fafafb",messageSize:"16px",backgroundColor:"#fc5a5a",position:"topRight",closeOnEscape:!0,close:!0,icon:"Icomoon",iconUrl:`${h}`,iconColor:"#fafafb"})}export{v as K,b as a,w as c,y as i};
//# sourceMappingURL=create-msg-e6f4ee7d.js.map
