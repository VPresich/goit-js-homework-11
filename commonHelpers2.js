import{g as l,c as i,B as h,a as u,b as g}from"./assets/create-msg-08ea2f6a.js";/* empty css                      */import{S as m}from"./assets/vendor-9310f15c.js";const t="/goit-js-homework-11/assets/icons-f810c139.svg",o=document.querySelector(".gallery"),s=document.querySelector(".loader"),a=document.querySelector(".search-form");a.addEventListener("submit",f);let n=new m(".gallery a",{captionsData:"alt",captionPosition:"bottom",captionDelay:250,nav:!0,navText:[`<svg class="lightbox-button-icon-prev" width="24" height="24" aria-label="icon arrow left">
